...
//======================================================================================
    ...
    //==================================================================================
    // CLASS DISTANCE BIAS (Auto-generated by Python)
    // Provides a per-class Hamming distance offset to reduce systematic class skew.
    //==================================================================================
`include "verilog_params/class_biases.vh"
    ...
    always @(posedge clk or negedge reset_b) begin
        ...
        if (!reset_b) begin
            ...
            if (!valid_s16 && class_state==1) begin // Falling edge of valid_s16
                 ...
                 //==========================================================================
                 min_d_int = hamming_distances[0] + get_class_distance_bias(0);
                 ...
                 for (i=1; i<NUM_CLASSES; i=i+1) begin
                     ...
                     `endif
                     adj_d = hamming_distances[i] + get_class_distance_bias(i);
                     if (adj_d < 0) adj_d = 0;
